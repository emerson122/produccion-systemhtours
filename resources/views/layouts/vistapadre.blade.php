    ...
    <div class="container-scroller">
        ...
        <nav class="sidebar sidebar-offcanvas" id="sidebar">
            ...
            <ul class="nav">
                ...
                {{-- modulo de cuentas  --}}
                @for ($i = 0; $i <= $largo; $i++)
                @if ($accesos[$i] == 'CUENTAS' || $accesos[$i] == 'SUBCUENTAS')
                ...
                <!-- Modulo Contable  -->
                @for ($i = 0; $i <= $largo; $i++)
                @if ($accesos[$i] == 'LIBRODIARIO' ||$accesos[$i] == 'PERIODO' || $accesos[$i] == 'BALANCE' || $accesos[$i] == 'RESULTADOS' || $accesos[$i] == 'RESULTADOS')
                <li class="nav-item menu-items">
                ...
                <!-- mantenimiento -->
                @for ($i = 0; $i <= $largo; $i++)
                @if ($accesos[$i] == 'CLASIFICACION' ||$accesos[$i] == 'GRUPOS' || $accesos[$i] == 'PERSONAS' || $accesos[$i] == 'OBJETOS')
                <li class="nav-item menu-items">
                ...
                @endfor
                   ...
                   @for ($i = 0; $i <= $largo; $i++)
                   @if ($accesos[$i] == 'USUARIOS'|| $accesos[$i] == 'ROLES' || $accesos[$i] == 'PERMISOS' || $accesos[$i] == 'BITACORAS' || $accesos[$i] == 'PARAMETROS' || $accesos[$i] == 'PREGUNTAS' )
